...
const serviciosPersonas = [
  ...
  'Préstamos bancarios',
  'Procesos bancarios y migratorios',
  'Visión patrimonial',
]

const serviciosEmpresas = [
  'Estructura administrativa, contable y financiera',
  'DGI y obligaciones fiscales',
  'CSS y trámites municipales',
  'Facturación y libros contables',
  'Control y flujo de caja',
  'Estados financieros estratégicos',
  'Perfil financiero empresarial',
  'Preparación para licitaciones públicas',
  'Líneas bancarias y expansión',
]

export default function FinanzasPage() {
  const whatsappLink = 'https://wa.me/50766841749?text=Hola,%20me%20interesa%20Finanzas.%20Me%20gustaría%20agendar%20una%20consulta.'
    ...
    <main>
      ...
      <section className="pt-14 pb-12 md:pt-20 md:pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Ordena, cumple y crece con estrategia financiera.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Claridad financiera y estructura sólida en Panamá — para personas, emprendedores y empresas.
          </motion.p>
        </div>
      </section>

      {/* Servicios por categoría: dos columnas */}
      <section className="pb-16 md:pb-24" aria-label="Servicios por categoría">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
            {/* Columna: Para personas */}
            <motion.article
            ...
            >
              <div className="bg-gradient-to-r from-slate-900 to-slate-800 px-6 md:px-8 py-6 md:py-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="font-display text-2xl md:text-3xl font-bold text-white">Para personas</h2>
                    <p className="text-white/80 text-sm md:text-base mt-1">Claridad financiera y perfil sólido para tu crecimiento</p>
                  </div>
                </div>
              </div>
              <div className="px-6 md:px-8 py-4">
                <ul className="divide-y divide-slate-100" role="list">
                  {serviciosPersonas.map((servicio, idx) => (
                ...
                <p className="text-slate-500 text-sm border-l-2 border-brand-yellow pl-4 mt-5 mb-4">
                  Perfil financiero sólido para acceder a crédito, oportunidades y crecimiento.
                </p>
              </div>
            </motion.article>

            {/* Columna: Para emprendedores y empresas */}
            <motion.article
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="bg-gradient-to-r from-slate-900 to-slate-800 px-6 md:px-8 py-6 md:py-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="font-display text-2xl md:text-3xl font-bold text-white">Para emprendedores y empresas</h2>
                    <p className="text-white/80 text-sm md:text-base mt-1">Estructura, cumplimiento y crecimiento con respaldo</p>
                  </div>
                </div>
              </div>
              <div className="px-6 md:px-8 py-4">
                ...
                <p className="text-slate-500 text-sm border-l-2 border-brand-yellow pl-4 mt-5 mb-4">
                  Tu empresa lista para competir, financiarse y crecer con respaldo estructural.
                </p>
              </div>
            </motion.article>
          </div>
      ...
      <section className="py-14 md:py-16 bg-slate-50 border-t border-slate-100">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-xl md:text-2xl font-bold text-slate-900 mb-2">¿Listo para ordenar y crecer?</h2>
          <p className="text-slate-600 text-sm mb-6">Plan a la medida — personal o empresarial.</p>
          <a
            href={whatsappLink}
            target="_blank"
